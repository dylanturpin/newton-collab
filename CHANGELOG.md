...
- Default the nightly dashboard to H1 Tabletop on first load, narrow the kernel-detail view to the final Newton ablation plus MuJoCo baseline, and hide low-signal kernel rows below a 1% cutoff.
