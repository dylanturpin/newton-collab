...
SWEEP_MAX_LOG2_G1_FLAT="${SWEEP_MAX_LOG2_G1_FLAT:-15}"
SWEEP_MIN_LOG2_H1_TABLETOP="${SWEEP_MIN_LOG2_H1_TABLETOP:-10}"
SWEEP_MAX_LOG2_H1_TABLETOP="${SWEEP_MAX_LOG2_H1_TABLETOP:-11}"
ABLATION_WORLDS_G1_FLAT="${ABLATION_WORLDS_G1_FLAT:-8192}"
ABLATION_WORLDS_H1_TABLETOP="${ABLATION_WORLDS_H1_TABLETOP:-2048}"
