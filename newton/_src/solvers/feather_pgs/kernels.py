...
# extents of the octagonal center-of-pressure bound. Matrix-free rows only.
PGS_CONSTRAINT_TYPE_PATCH_MOMENT = 7
...
# ``mu`` stores mu_c * r_eff [m] (clamp = mu * F). Matrix-free rows only.
PGS_CONSTRAINT_TYPE_PATCH_TORSION = 8
